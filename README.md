...
¡Hola! Bienvenido a mi Trabajo de Fin de Grado. He creado una tienda online completa desde cero.
...
Para que la tienda funcione en tu ordenador, necesitas tres programas básicos:
1. **Java (JDK 17 o superior):** Es el "motor" que hace funcionar la página.
2. **Xampp:** Para correr mysql.
...
¡Listo! Arriba en la cabecera te aparecerá un botón rojo que dice PANEL ADMIN.

¡Rellena el catálogo! Entra en ese panel y usa el formulario "Añadir Nuevo Producto". Invéntate un par de artículos (puedes buscar fotos en internet y pegar su enlace) y dale a guardar. Si vuelves a la página principal, ¡verás que tu tienda ya tiene tus productos expuestos!
...
![img.png](img.png)
Tambien podras eliminar comentarios negativos de parte de los usuarios que no tengan nada que ver con los productos
...
Tambien puedes meterte en tu perfil como usuario para tener la factura de tus compras, con lo que te has gastado y lo que has coprado , asi tendras un registro de lo que compras cuanto compras con fecha y cantidada de dinero.
...
Lo mejor de todo: Una vez que inicie sesión o se registre, los productos que tenía metidos en la cesta no se pierden, siguen ahí listos para finalizar la compra de forma segura.